    ...
    <div class="border-y border-line bg-white">
        <div class="mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[15rem_1fr] lg:px-10 lg:py-20">
            ...
            <div class="min-w-0 space-y-20">
                ...
                <section id="cryptography" class="scroll-mt-8">
                ...
                <section id="trust-privacy" class="scroll-mt-8">
                ...
                <section id="independence" class="scroll-mt-8">
                ...
                <section id="status" class="scroll-mt-8">
                ...
                <section id="design-sources" class="scroll-mt-8">
