...
- 🟨 Build the extension without remotely hosted code, publish source/build hashes, and submit the fixed production identity to the Chrome Web Store. Production package was built, verified, hashed, and uploaded to the reserved item; final review submission remains deferred. Runbook: [§9](../operations/phase12-production-runbook.md#9-extension-build-and-store-submission).
...
- ⬜️ Audit the complete public working tree and history for secrets, local data, logs, generated artifacts, unrelated private information, and third-party licensing obligations. Runbook: [§11](../operations/phase12-production-runbook.md#11-public-repository-and-history-audit).
...
- ⬜️ Publish the static reference Host and downloadable example Capsules. Runbook: [§12](../operations/phase12-production-runbook.md#12-static-reference-host).
- ⬜️ Verify the production static-host contract: public noncredentialed CORS, immutable revision URLs, bounded content lengths, accepted Capsule media type, and cache/header behavior that works from a separately hosted page. Runbook: [§12](../operations/phase12-production-runbook.md#12-static-reference-host).
...
- ⬜️ Run clean-account creator and viewer acceptance tests against production-like infrastructure. Runbook: [§14](../operations/phase12-production-runbook.md#14-acceptance-load-and-concurrency-testing).
