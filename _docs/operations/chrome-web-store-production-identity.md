...
- 2026-07-29: The Chrome Web Store-installed extension was reconnected and verified against the Phase 12 test page; the protected TekFoundry logo rendered successfully.
- 2026-07-29: The public listing URL returned HTTP `200`.
- 2026-08-01: Prepared no-behavior-change maintenance release candidate `share-capsules-extension-0.1.1-production.zip` after extracting reusable Creator code into `@sharecapsules/capsule-creator`. ZIP SHA-256: `d9544366a50a571fdd3509561b06fcb9312c03e914f57c442086240ecf883c66`. Production-mode supply-chain aggregate SHA-256: `b8a8ef92dea389e9f21f15bc74f7c0416611300255520a508ac92d6f712dd756`.
- 2026-08-02: Chrome Web Store review passed and extension version `0.1.1` was released for extension ID `jkejpdcobbbeichpodpeoiilnalepdph`. The store-installed extension continued to render the production test page, now canonicalized at `https://sharecapsules.com/capsule-test`.
- 2026-08-02: Prepared production release candidate `share-capsules-extension-0.1.3-production.zip` for the showcase Viewer presentation update. ZIP SHA-256: `43ddce477a6c57a75397df0cc80affd69029c93d2015a968848fd0e5412cc9a7`. Production-mode supply-chain aggregate SHA-256: `0c2a6141dd50540199c8249c09c8d755a441effa27dfb558658b903e0e85d532`.
- 2026-08-02: Maintainer uploaded extension version `0.1.3` to the existing Chrome Web Store item and requested review for extension ID `jkejpdcobbbeichpodpeoiilnalepdph`.
